async function drawChart() {
  ...
  const gradientColorScale = d3.interpolatePlasma
  ...
  drawAnnotation(Math.PI * 0.734, uvOffset + 0.05, `UV Index Over ${uvIndexThreshold}`)
  drawAnnotation(Math.PI * 0.7, 0.5, "Temperature")
  if (containsFreezing) {
    drawAnnotation(Math.PI * 0.9, radiusScale(32) / dimensions.boundedRadius, "Freezing Temperatures")
  }
